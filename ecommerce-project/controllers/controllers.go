...
import (
	...
	"github.com/musyokajames/ecommerce-project/database"
	"github.com/musyokajames/ecommerce-project/models"
	generate "github.com/musyokajames/ecommerce-project/tokens"
...
func SignUp() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		if inserterr != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "theuser did not get created"})
			return
		}
		defer cancel()
